...
$query = ("INSERT INTO usuarios (nombre,apaterno,amaterno,telefono,correo,user_name,password) VALUES ('$nombre','$apaterno','$amaterno','$telefono','$correo','$nombre','holamundo123')");	
